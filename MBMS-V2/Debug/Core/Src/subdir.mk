...
=======
	-$(RM) ./Core/Src/BatteryControlTask.cyclo ./Core/Src/BatteryControlTask.d ./Core/Src/BatteryControlTask.o ./Core/Src/BatteryControlTask.su ./Core/Src/StartupTask.cyclo ./Core/Src/StartupTask.d ./Core/Src/StartupTask.o ./Core/Src/StartupTask.su ./Core/Src/app_freertos.cyclo ./Core/Src/app_freertos.d ./Core/Src/app_freertos.o ./Core/Src/app_freertos.su ./Core/Src/can_rx.cyclo ./Core/Src/can_rx.d ./Core/Src/can_rx.o ./Core/Src/can_rx.su ./Core/Src/can_tx.cyclo ./Core/Src/can_tx.d ./Core/Src/can_tx.o ./Core/Src/can_tx.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32h5xx_hal_msp.cyclo ./Core/Src/stm32h5xx_hal_msp.d ./Core/Src/stm32h5xx_hal_msp.o ./Core/Src/stm32h5xx_hal_msp.su ./Core/Src/stm32h5xx_it.cyclo ./Core/Src/stm32h5xx_it.d ./Core/Src/stm32h5xx_it.o ./Core/Src/stm32h5xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32h5xx.cyclo ./Core/Src/system_stm32h5xx.d ./Core/Src/system_stm32h5xx.o ./Core/Src/system_stm32h5xx.su
>>>>>>> dev
